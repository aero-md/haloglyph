...
/**
 * Générateur de `plumb_toy_preview.xml` — l'icône du toy dans Glyph Interface.
 *
...
class PreviewVectorDump {
    ...
    fun dump() {
        ...
        PlumbRenderer(spec, fromBack = true).render(
            frame,
            PlumbEngine.Reading(
                tiltDegrees = 1.6f,
                dirX = -0.42f,
        ...
        val out = File("build/plumb_toy_preview.xml")
    ...
    private companion object {
        ...
        val HEADER = """
            ...
            <!-- Apercu du toy pour Glyph Interface et pour le selecteur de widgets : le
                 niveau, bulle legerement hors de la couronne, rendu par PlumbRenderer a la
