 ...
 *   [PlumbScale]) — une dizaine de cellules par degré. Un filtre rapide y
...
class PlumbEngine {
     ...
     * notification.
     */
    var range: PlumbRange = PlumbRange.DEFAULT
    ...
    private fun recompute() {
        ...
        if (vertical) plumbAxis(ux, uy) else flatPlane(ux, uy)
     ...
     */
    private fun plumbAxis(ux: Float, uy: Float) {
