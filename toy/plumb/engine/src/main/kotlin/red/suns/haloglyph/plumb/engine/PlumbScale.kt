...
object PlumbScale {
     ...
     *
     * @param fullScale l'inclinaison qui colle la bulle au bord. Voir [PlumbRange].
     ...
     */
    fun tolerance(range: PlumbRange): Float = tiltAt(LOCK_FRACTION, range.degrees, 1f)
 ...
 */
enum class PlumbRange(val degrees: Float, val label: String) {
    FINE(5f, "5°"),
    NORMALE(15f, "15°"),
    LARGE(45f, "45°");
    ...
    companion object {
        ...
        fun byKey(key: String?): PlumbRange = entries.firstOrNull { it.name == key } ?: DEFAULT
    }
}
