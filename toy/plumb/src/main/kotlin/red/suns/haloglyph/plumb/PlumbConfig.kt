package red.suns.haloglyph.plumb
...
object PlumbConfig {
    ...
    fun mode(prefs: SharedPreferences): PlumbMode =
        PlumbMode.byKey(prefs.getString(KEY_MODE, null))

    fun setMode(prefs: SharedPreferences, mode: PlumbMode) {
        prefs.edit().putString(KEY_MODE, mode.name).apply()
    }

    fun range(prefs: SharedPreferences): PlumbRange =
        PlumbRange.byKey(prefs.getString(KEY_RANGE, null))

    fun setRange(prefs: SharedPreferences, range: PlumbRange) {
