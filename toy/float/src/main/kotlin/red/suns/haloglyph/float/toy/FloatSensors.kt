...
/**
 * Le branchement des capteurs sur [FloatEngine] — la seule classe du toy qui
...
internal class FloatSensors(
    ...
    private fun syncCompass() {
        ...
        if (compass && !compassListening) {
            ...
            // pris tel quel, avec une zone morte, voir `FloatEngine.onHeading` — et
